import pandas as pd
import os
#execute this script in the root directory 'kaggle-rsna-intracranial-hemorrhage'

os.system('sh bin/preprocess.sh')
os.system('sh bin/predict001.sh')
os.system('sh bin/fold1predict.sh')
os.system('sh bin/fold2predict.sh')
os.system('sh bin/fold3predict.sh')
os.system('sh bin/fold4predict.sh')
